        ...
        <div id="conteneur">
            ...
            <div id="contenu">
				...
				<div id="padding">
					...
					<br /><br />
                     Compte à consulter : <asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>
                   <br /><br />
                    <asp:Button ID="bt_valid" runat="server" Text="Valider" OnClick="bt_valid_Click" style="height: 26px" />
				</div>
            </div>
            <!-- PIED DE LA PAGE -->
            <div id="pied">
